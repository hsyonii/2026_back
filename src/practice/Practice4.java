...
public class Practice4 {
    public static void main(String[] args) {
        ...
        if(주민번호.charAt(7) == 1 || 주민번호.charAt(7) == 3)
        ...
        if(number2<number1 && number3<number1){
            큰수1 = number1;
            if(number1<number2){ //큰수2 = number2
                큰수2 = number2;
                큰수3 = number3;
            }   
            //큰수2=number3
        ...
        System.out.printf("%d  %d  %d",큰수3,큰수2,큰수1);
        ...
        else if((플1==0&&플2==1)||(플1==1&&플2==2)||(플1==2&&플2==0))
